...
namespace CsGrafeq
{
    internal static class ExpressionCompiler
    {
        ...
        public static CompileResult Compile(string Expression)
        {
            ...
            return new CompileResult {MarchingSquaresDelegate=msd ,IntervalSetImpFunctionDelegate=IntervalSetDg,UsedConstant=usedconst};
        }
        ...
        internal struct CompileResult
        {
            ...
            public void Deconstruct( out IntervalSetImpFunctionDelegate isfunc, out MarchingSquaresDelegate msd,out bool[] usedconstant)
            {
