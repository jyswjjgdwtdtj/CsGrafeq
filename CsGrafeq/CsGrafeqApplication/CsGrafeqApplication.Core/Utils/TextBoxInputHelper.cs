...
public static class TextBoxInputHelper
{
    public static IFocusManager? IFocusManager => Avalonia.Application.Current?.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop
        ? desktop.MainWindow?.FocusManager
        : Avalonia.Application.Current?.ApplicationLifetime is ISingleViewApplicationLifetime view?TopLevel.GetTopLevel(view.MainView)?.FocusManager : null;

    public static readonly FocusManager? FocusManager;

    static TextBoxInputHelper()
    {
        if (IFocusManager is FocusManager manager)
        {
            FocusManager = manager;
        }
    }
    
    public static bool TryFindTextBox(out TextBox textBox)
    {
        var f = IFocusManager?.GetFocusedElement();
    ...
    public static bool Input(KeyboardInput input)
    {
        var f = IFocusManager?.GetFocusedElement();
    ...
    extension(TextBox textBox)
    {
        ...
        public void InsertTextAtCursor(string textToInsert, bool moveCursorToEnd = true)
        {
            if (textBox == null)
