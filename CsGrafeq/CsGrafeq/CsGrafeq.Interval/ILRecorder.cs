...
namespace CsGrafeq.Interval
{
    public class ILRecorder
    {
        ...
        public void EmitCalli(OpCode opcode, System.Runtime.InteropServices.CallingConvention cc, Type? ret, Type[]? para)
        {
            sb.AppendLine($"{opcode.Name} CallingConventions:{cc},ReturnType:{ret},Parameters:[{string.Join(", ", para ?? Array.Empty<Type>())}]");
