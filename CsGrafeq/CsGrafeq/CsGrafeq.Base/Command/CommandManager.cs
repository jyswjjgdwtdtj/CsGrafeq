...
public class CommandManager
{
    ...
    public void Do(object? tag,Action<object?> initFunc, Action<object?> doFunc, Action<object?> unDoFunc, Action<object?> clearFunc, bool invokeDo = false)
    {
        ...
        _doList.AddLast(new CommandBase(tag,initFunc, doFunc, unDoFunc, clearFunc));
