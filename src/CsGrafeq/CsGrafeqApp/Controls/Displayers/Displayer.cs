...
public abstract class Displayer : SkiaControl
{
    ...
    protected event EventHandler<KeyEventArgs>? MyKeyDown;
    protected event EventHandler<KeyEventArgs>? MyKeyUp;
    protected virtual void OnMyKeyDown(KeyEventArgs e)=> MyKeyDown?.Invoke(this, e);
    protected virtual void OnMyKeyUp(KeyEventArgs e)=> MyKeyUp?.Invoke(this, e);
    public void RaiseMyKeyDown(KeyEventArgs e)=>OnMyKeyDown(e);
    public void RaiseMyKeyUp(KeyEventArgs e)=>OnMyKeyUp(e);
