...
using static CsGrafeqApp.Shapes.ShapeGetter.LineGetter;
...
namespace CsGrafeqApp.Shapes
{
    public abstract class Line : Shape
    {
        ...
        public override LineGetter Getter
        {
            get => LineGetter;
        }
        ...
        {
            double res = DistanceToLine(Current.Point1, Current.Point2, vec, out Vec point);
