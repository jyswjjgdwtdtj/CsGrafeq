...
public static class ColorExtension
{
    ...
    private static readonly double k = System.Math.Pow(1 / (1 + System.Math.Pow(1.5, 2.2) + System.Math.Pow(0.6, 2.2)), 1 / 2.2);
    ...
    {
        return (k * sysMath.Pow(sysMath.Pow(((double)c.R / 255), 2.2) + sysMath.Pow(((double)c.G / 255 * 1.5), 2.2) + sysMath.Pow(((double)c.B / 255 * 0.6), 2.2), 1 / 2.2));
    }
}